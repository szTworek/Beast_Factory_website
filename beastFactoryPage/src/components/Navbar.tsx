...
const Navbar: React.FC = () => {
    ...
    const handleClickCategories = (prop: string) => {
    ...
    return (
        <>
            {!isMobile && (
                <div className="navBar">
                    <div className="Logo">
                        <NavLink to="/">
                            <img
                                src="../../images/BeastFactoryLogo3.png"
                                alt="Logo"
                                className="logo"
                            />
                        </NavLink>
                    ...
                    <div className="pages">
                        ...
                        >
                            <NavLink to="/weights">Wolne ciężary</NavLink>
                            {activeDropdown === "weights" && (
                                <div className="dropdownMenu">
                                    <NavLink to="/weights/1">Wolne ciężary 1</NavLink>
                                    <NavLink to="/weights/2">Wolne ciężary 2</NavLink>
                                </div>
                            )}
                        </div>
                        <div
                            ...
                            onMouseLeave={handleMouseLeave}
                        >
                            <NavLink to="/machines">Sprzęt siłowy</NavLink>
                            {activeDropdown === "machines" && (
                                <div className="dropdownMenu">
                                    <NavLink to="/machines/1">Maszyny</NavLink>
                                    <NavLink to="/machines/2">Ławki</NavLink>
                                </div>
                            )}
                        </div>
                        <div
                    ...
                    <div className="user">
                        <NavLink to="/Search">
                            <img
                                src="../../images/search_10486682.png"
                                alt="search"
                                className="icon"
                            />
                        </NavLink>
            ...
            {isMobile && (
                <div className="navBar">
                    <img
                        src="../../images/BeastFactoryLogo2.png"
                        alt="Logo"
                        className="logo"
                    />
                    <div className="user">
                    ...
                    {menuOpen && (
                        <div className="dropdownMenu">
                            <div
                                onClick={() => handleClickCategories("weights")}
                                className="category"
                            >
                                Sprzęt siłowy
                            </div>
                            ...
                            <div
                                onClick={() => handleClickCategories("machines")}
                                className="category"
                            >
                                Wolne ciężary
                            </div>
                            ...
                            <div
                                onClick={() => handleClickCategories("bundles")}
                                className="category"
                            >
                                Stojaki
                            </div>
